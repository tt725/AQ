...
class QLearner:
    def __init__(self, epsilon=1.0, gamma=0.95, learningRate=0.5):
    ...
    def init_Q_table(self):
        self.Q1 = np.random.normal(0, 1, size=(Env().nState, Env().nAction))
        self.Q2 = np.random.normal(0, 1, size=(Env().nState, Env().nAction))
